...
var energieLeverancier = 'edinet';
var energieLevFilename = 'EdinetGeoVerbruik'
...
*/
	getData: function (featureOfInterest, param, callback) {
		...
		fileLocation = energieLevLocalPath + energieLevFilename + '-' + param.product + '-all-2016.json';
...
var findLocalLiander = function (product, fileLocation) {
  	var _energieLevFile;
